...
class LazyBlocks_Blocks {
    ...
    public function add_settings_metabox() {
        ...
        */
        ...
        <div class="lzb-metabox">
            <label><?php echo esc_html__( 'Supports', 'lazy-blocks' ); ?></label>
            ...
            <label>
                ...
                <?php echo esc_html__( 'Show in Blocks Inserter', 'lazy-blocks' ); ?>
            </label>
        </div>
    ...
    public function add_code_metabox() {
        ...
        <div class="lzb-metabox">
            <br>
            <p class="description">
                <?php echo esc_html__( 'Note 1: if you use blocks as Metaboxes, you may leave these code editors blank.', 'lazy-blocks' ); ?>
            </p>
            <p class="description">
            ...
            <p class="description">
                <?php echo wp_kses_post( __( 'Note 3: yep, I know that Gutenberg based on React, but c\'mon... converting a string with JSX to React components is much more complicated than simple text replacements (Handlebars).', 'lazy-blocks' ) ); ?>
            </p>
        </div>
        <?php
    }
